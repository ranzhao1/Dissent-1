...
namespace BlogDrop {
  ...
  bool PairingServerCiphertext::VerifyProof(int phase, const QSharedPointer<const PublicKey> pub) const
  {
    // g0 = DH generator 
  ...
  QByteArray PairingServerCiphertext::GetByteArray() const 
  {
    QList<QByteArray> list;
