...
namespace BlogDrop {
  ...
  class BlogDropServer {
    ...
    public:
       ...
       * @param in serialized ciphertext to add
       ...
       *
       * WARNING : You must call CloseBin() before calling this method
       * @param in the list of serializd server ciphertexts to add
       * @param pubs the public keys of the servers who sent the ciphertext
       */
