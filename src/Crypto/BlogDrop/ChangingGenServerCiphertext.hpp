...
namespace BlogDrop {
  ...
  class ChangingGenServerCiphertext : public ServerCiphertext {
    ...
    public:
       ...
       * @param priv Server private key used to generate proof
       */
    ...
    protected:
       ...
       * It should return a group generator that is a generated using a 
       * hash of the arguments.
       * @param server_pks server public keys
       * @param author_pks author public key
       * @param phase message transmission phase
       * @param element_idx element index within a message
       */
