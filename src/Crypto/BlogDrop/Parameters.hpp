    ...
    namespace BlogDrop {
      ...
      class Parameters {
        ...
        public:
          ...
          /** 
           * Set the round nonce
           * @param nonce new round nonce
           */
          virtual inline void SetRoundNonce(QByteArray nonce) { _round_nonce = nonce; }

          /** 
           * Set the number of elements in a ciphertext
           * @param new_n number of elements
           */
          virtual inline void SetNElements(int new_n) { _n_elements = new_n; }

          /** 
           * Get the number of elements in a ciphertext
           */
