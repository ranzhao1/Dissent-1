...
HEADERS += ext/joyent-http-parser/http_parser.h \
    ...
    src/Crypto/IBEPrivateKey.hpp \
    src/Crypto/IBEPublicKey.hpp \
    src/Crypto/SystemParam.hpp \
    src/Crypto/PkgServer.hpp \
    src/Utils/IBEUtils.hpp
...
SOURCES += ext/joyent-http-parser/http_parser.c \
    ...
    src/Crypto/SystemParam.cpp \
    src/Crypto/IBEPrivateKey.cpp \
    src/Crypto/IBEPublicKey.cpp \
    src/Crypto/PkgServer.cpp \
    src/Crypto/main.cpp \
    src/Utils/IBEUtils.cpp
...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../../../../../usr/local/lib/release/ -lbotan-1.10
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../../../../../usr/local/lib/debug/ -lbotan-1.10
else:symbian: LIBS += -lbotan-1.10
else:unix: LIBS += -L$$PWD/../../../../../usr/local/lib/ -lbotan-1.10

INCLUDEPATH += $$PWD/../../../../../usr/local/include/botan-1.10
DEPENDPATH += $$PWD/../../../../../usr/local/include/botan-1.10

win32:CONFIG(release, debug|release): PRE_TARGETDEPS += $$PWD/../../../../../usr/local/lib/release/botan-1.lib
else:win32:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$PWD/../../../../../usr/local/lib/debug/botan-1.lib
else:unix:!symbian: PRE_TARGETDEPS += $$PWD/../../../../../usr/local/lib/libbotan-1.10.a

win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../../../../../opt/local/lib/release/ -lcryptopp
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../../../../../opt/local/lib/debug/ -lcryptopp
else:symbian: LIBS += -lcryptopp
else:unix: LIBS += -L$$PWD/../../../../../opt/local/lib/ -lcryptopp

INCLUDEPATH += $$PWD/../../../../../opt/local/include/cryptopp
DEPENDPATH += $$PWD/../../../../../opt/local/include/cryptopp

win32:CONFIG(release, debug|release): PRE_TARGETDEPS += $$PWD/../../../../../opt/local/lib/release/cryptopp.lib
else:win32:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$PWD/../../../../../opt/local/lib/debug/cryptopp.lib
else:unix:!symbian: PRE_TARGETDEPS += $$PWD/../../../../../opt/local/lib/libcryptopp.a

win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../../../../../usr/local/openssl/release/ -lcrypto
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../../../../../usr/local/openssl/debug/ -lcrypto
else:symbian: LIBS += -lcrypto
else:unix: LIBS += -L$$PWD/../../../../../usr/local/openssl/ -lcrypto

INCLUDEPATH += $$PWD/../../../../../usr/local/openssl/include
DEPENDPATH += $$PWD/../../../../../usr/local/openssl/include

win32:CONFIG(release, debug|release): PRE_TARGETDEPS += $$PWD/../../../../../usr/local/openssl/release/crypto.lib
else:win32:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$PWD/../../../../../usr/local/openssl/debug/crypto.lib
else:unix:!symbian: PRE_TARGETDEPS += $$PWD/../../../../../usr/local/openssl/libcrypto.a
